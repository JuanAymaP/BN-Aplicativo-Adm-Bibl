...
Public Class frm_mantenimientoLibro
    ...
    Private Sub Busqueda() 'Funcion/Procedimiento de búsqueda
        ...
        Dim Valor As String = TxtBusqueda.Text.Trim 'Variable que guardara la cadena ingresada en el campo de busqueda
    ...
    Private Sub GeneraLog(ByVal v_opcion As String, ByVal v_valor As String) 'Funcion/procedimiento
        Try
            Dim tupla_FechaHora As Tuple(Of String, String) = Formato_Fecha_Hora()
            Dim cUser_Fecha_Ing As String = tupla_FechaHora.Item1
            Dim cUser_Hora_Ing As String = tupla_FechaHora.Item2
            Dim cUser_quien_consulta As String = Session("s_NomUsuario")
            Dim IPAdd As String = CapturaIP()
            Dim cUser_TemaBuscado As String = v_valor
    ...
    Private Sub Exportar_Reporte_Libro(ByVal FormatoReporte As String, ByVal v_TipoReporte As String)
        ...
        vLibro = Session("MLibro_codRegistro")
        vBandera = "7"
